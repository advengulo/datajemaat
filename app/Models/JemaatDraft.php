...
class JemaatDraft extends Model
{
    /**
    ...
    /**
     * Get the jemaat record this draft is associated with.
     */
    public function jemaat(): BelongsTo
    {
        return $this->belongsTo(data_jemaat::class, 'jemaat_id');
    }
